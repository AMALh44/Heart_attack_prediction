...
resting_bp = st.number_input('Resting Blood Presuure', min_value=0, max_value=200,value=45)
cholestrol = st.number_input('Cholestrol', min_value=0, max_value=500, value=230)
fastinng_bs = st.selectbox('Fasting Blood Sugar', ['0','1'])
resting_ecg = st.selectbox('Resting EGG', ['Normal', 'ST', 'LVH'])
